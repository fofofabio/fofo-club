      ...
      <SectionFade once threshold={0.2}>
        <section className="mx-auto max-w-5xl px-6 pt-16 pb-10">
          ...
          <h1 className="font-display text-4xl md:text-6xl leading-[1.03] tracking-[-0.01em] max-w-[22ch]">
            i’m fabio. i make fast, minimal things — design, code, and motion — under fofo club.
          </h1>
          <p className="mt-5 text-lg text-black/80 max-w-2xl">
            based in {profile.location}. born{" "}
            {new Date(profile.birthdate).toLocaleDateString("en-GB", {
              day: "2-digit",
              month: "short",
              year: "numeric",
            })}{" "}
            — {profile.age} years old. fofo club started as a playground and became a tiny world about movement,
        ...
        <section className="relative isolate overflow-hidden">
          ...
          <div className="relative mx-auto max-w-5xl px-6 py-14 text-white">
            <p className="text-xl md:text-2xl leading-relaxed max-w-3xl">
              fofo club isn’t a portfolio or a brand — it’s motion. i like things that feel light, sharp, and honest.
              i build interfaces and little systems; sometimes they become shirts or tools my friends and i use.
            </p>
          </div>
        </section>
      </SectionFade>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <div>
              ...
              <div className="card p-5 flex flex-wrap items-center gap-4">
                <Link href="mailto:fabio.unterholzer@outlook.com" className="hover:text-fofo-blue transition">
                  hi@fofoclub
                </Link>
                <span className="text-black/30">·</span>
                <Link href="https://github.com/fofofabio" className="hover:text-fofo-blue transition">
                  github
                </Link>
                <span className="text-black/30">·</span>
                <Link
                ...
                <span className="text-black/30">·</span>
                <Link href="/LebenslaufUnterholzer.pdf" className="hover:text-fofo-blue transition" download>
                  download pdf
                </Link>
              </div>
            </div>
